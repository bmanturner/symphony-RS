...
- [x] Add strict validation that instruction file paths stay inside the repo/workflow root.
- [x] Add strict validation that configured instruction files exist and are readable.
...
- [x] Add negative tests for path traversal, missing instruction files, unknown instruction keys, and missing eligible child-owning roles.
